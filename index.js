...
function handlePostback(sender_psid, received_postback) {
  ...
  if (payload === '<postback_payload>') {
    ...
    response = localcenters('Medical help for sexual assault can be found at all health centers. However, not all hospitals have trained staff members to help perform a sexual assault medical forensics exam. To ensure you get the best care possible, you can get in touch with RAINN to help locate a health center near you with the resources you need. They can help guide you through the process of receiving medical care and sexual assault forensic exam as well as provide a trained advocate to accompany you to the hospital. Although the sexual assault forensic exam is not mandatory, it is recommended to collect evidence in the case that you do decide to report in the future.')

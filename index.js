...
function handlePostback(sender_psid, received_postback) {
  ...
  if (payload === '<postback_payload>') {
    ...
    response = localcenters('You can find medical help for sexual assault all health centers. However, not all hospitals have trained staff members on site to help perform a sexual assault medical forensics exam. To ensure you can get the best care possible, you can get in touch with RAINN who would help locate a health center near you with the resources you need. They can help guide you through the process of receiving medical care and sexual assault forensic exam as well as provide a trained advocate to accompany you to the hospital. Although the sexual assault forensic exam is not mandatory, it is recommended to collect evidence in the case that you do decide to report the crime in the future.')
    ...
    //response = {"text": "doesthiswork?"}
    response = reportingresources('There are many resources available. Remember you are not alone. \n RAINN is a confidential anti-sexual violence organization with a 24/7 hotline and many available resources who can support you either with finding medical services and reporting sexual assault. \n NSVRC is a national network of community-based crisis centers and local organizations that support sexual assault survivors through advocacy, accompaniment, follow-up services, as well as referrals to other resources. \n YWCA is network of domestic and sexual violence service providers for women offering safe housing, crisis hotlines, counseling, and court assistance to women, children, and families.')
  }
    ...
    response = notrecent('One in every six American women is the survivor of a rape or an attempted rape in her lifetime. Yet, about 75% of that remains unreported. There are many legitimate reasons why this statistic is so and it is never the fault of the victim. Some of these reasons include: fear of retaliation, lack of support, self-blame, did not want trouble, did not realize it was rape, etc. However, a women who do report sexual assault say that they do so to find justice for themselves, protect themselves from further assault, prevent recurrence or escalation, felt a duty to do so, get help or recover, etc. \n The current statue of limitations vary from state to state, however, many efforts have been made to push the statue of limitations further or even push to remove the statue of limitations for sexual crimes. Even if assault is not recent, many surviors decide to report later on. Should you choose to do so, there are many resources available.')
  }
